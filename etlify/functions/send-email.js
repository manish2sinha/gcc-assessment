                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td style="padding: 24px 0 0;">
                          <p style="margin: 0 0 6px; font-size: 13px; color: rgba(255,255,255,0.5); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">Best regards,</p>
                          <p style="margin: 0 0 4px; font-size: 14px; font-weight: 500; color: #f0ede8; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">Manish Sinha</p>
                          <p style="margin: 0 0 4px; font-size: 12px; color: rgba(255,255,255,0.4); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif;">GCC Organization Design Partner · Bangalore</p>
                          <a href="mailto:manish@manishsinha.com" style="font-size: 12px; color: rgba(255,255,255,0.4); font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; text-decoration: none;">manish@manishsinha.com</a>
                        </td>
                      </tr>
                    </table>
